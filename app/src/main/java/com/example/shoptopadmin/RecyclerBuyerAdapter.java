...
public class RecyclerBuyerAdapter extends FirebaseRecyclerAdapter<BuyerModel,RecyclerBuyerAdapter.ViewHolder> {

    public RecyclerBuyerAdapter(@NonNull FirebaseRecyclerOptions<BuyerModel> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull RecyclerBuyerAdapter.ViewHolder holder, int position, @NonNull BuyerModel model) {
